...
let firstArr = [
  { name: "bulbasaur", type: ["poison", "grass"] },
  { name: "charmander", type: ["fire"] },
  { name: "kakuna", type: ["bug", "poison"] },
  { name: "oddish", type: ["poison", "grass"] },
];
...
let avgAttack = [
  ...
  { stats: { "base-attack": "151" } },
  { stats: { "base-attack": "198" } },
];
let avgAtt = "155.67";
...
let avgDefense = [
  { stats: { "base-defense": "111" } },
  { stats: { "base-defense": "143" } },
  { stats: { "base-defense": "189" } },
];
let avgDef = "147.67";
